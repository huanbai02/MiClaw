...
def benchmark():
    """性能基准测试"""
    print("=" * 70)
    print("MiClaw 懒加载性能基准测试")
    print("=" * 70)
    
    # 创建临时测试目录
    temp_dir = tempfile.mkdtemp(prefix="miclaw_bench_")
    
    # 修改环境变量
    original_env = os.environ.get("MICLAW_WORKSPACE")
    os.environ["MICLAW_WORKSPACE"] = temp_dir
    ...
    try:
        ...
        if original_env is not None:
            os.environ["MICLAW_WORKSPACE"] = original_env
        else:
            os.environ.pop("MICLAW_WORKSPACE", None)
